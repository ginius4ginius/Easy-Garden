...
import com.pro.ginius.easygarden.outils.DatabaseHandler;
    ...
    /* Clic sur le bouton Login */
        ...
        /* On construit la liste des paramètres de la requête */
          ...
          /* Exécute la requête vers le serveur local */
                    ...
                    HttpPost httppost = new HttpPost("http://172.16.1.134/easyGarden/index.php");   // IMPORTANT ici localhost = 10.0.2.2
