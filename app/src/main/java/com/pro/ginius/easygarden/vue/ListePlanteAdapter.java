...
public class ListePlanteAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        holder.tvNom.setText(lesPlantes.get(i).getNom());
        holder.tvNomScientifique.setText(lesPlantes.get(i).getNomScientifique());
        holder.tvDescriptif.setText(lesPlantes.get(i).getDescriptif());
        holder.tvType.setText(lesPlantes.get(i).getType());
        holder.tvExposition.setText(lesPlantes.get(i).getExposition());
        holder.btnAddFavori.setTag(i);
        holder.imagePlante.setImageResource(i);
        return null;
    }
